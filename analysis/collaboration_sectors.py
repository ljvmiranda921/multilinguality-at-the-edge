...
VALUE_LABELS = [
    ...
    {"x": -0.60, "y": -0.22, "label": 42},  # Academia self
    {"x": 0.43, "y": -0.60, "label": 20},  # Industry self
    {"x": 0.55, "y": 0.45, "label": 14},  # Research collective self
    {"x": 0.10, "y": 0.68, "label": 5},  # Government self
    # --- cross-counts (on the connecting ribbon) ---
    {"x": 0.03, "y": -0.20, "label": 11},  # Academia–Industry
    {"x": 0.18, "y": 0.10, "label": 12},  # Academia–Research collective
    {"x": 0.08, "y": 0.46, "label": 3},  # Academia–Government
    {"x": 0.24, "y": -0.25, "label": 7},  # Industry–Research collective
    {"x": 0.15, "y": 0.30, "label": 3},  # Industry–Government
